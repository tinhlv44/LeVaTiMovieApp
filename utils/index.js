...
export const changePasswordValidationSchema = Yup.object().shape({
  ...
  newPassword: Yup.string()
    ...
    .matches(/[a-z]/, "Mật khẩu mới phải chứa ít nhất một chữ cái thường")
    .matches(/[A-Z]/, "Mật khẩu mới phải chứa ít nhất một chữ cái hoa")
    .matches(/\d/, "Mật khẩu mới phải chứa ít nhất một chữ số")
    .matches(/[!@#$%^&*(),.?":{}|<>]/, "Mật khẩu mới phải chứa ít nhất một ký tự đặc biệt")
    .label('Mật khẩu mới'),

  confirmPassword: Yup.string()
    .oneOf([Yup.ref('newPassword')], 'Mật khẩu xác nhận phải trùng khớp với mật khẩu mới')
    .required('Mật khẩu xác nhận là bắt buộc')
    .label('Mật khẩu xác nhận')
});
